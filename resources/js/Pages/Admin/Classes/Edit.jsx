...
export default function Edit({ auth, creativeClass }) {
    ...
    const { data, setData, post, processing, errors } = useForm({
        ...
        dates: creativeClass.dates ? creativeClass.dates : [], // Array of date strings
                            ...
                            <div className="mt-6 border-t border-gray-100 dark:border-gray-700 pt-6">
                                <div className="flex items-center justify-between mb-4">
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-500 dark:text-gray-400">Daftar tanggal pelaksanaan kelas.</p>
                                    </div>
                                    <button
                                        type="button"
                                        onClick={addDate}
                                ...
                                {data.dates.length === 0 ? (
                                    ...
                                    <div className="space-y-4">
                                        {data.dates.map((dateString, index) => {
                                            // Handle cases where the saved date might just be a string, not a Date object yet
